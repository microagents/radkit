...
impl ContentPart {
    ...
    #[must_use] pub const fn as_text(&self) -> Option<&str> {
    ...
    #[must_use] pub fn into_text(self) -> Option<String> {
        if let Self::Text(content) = self {
            Some(content)
        } else {
            None
    ...
    #[must_use] pub const fn as_tool_call(&self) -> Option<&ToolCall> {
    ...
    #[must_use] pub fn into_tool_call(self) -> Option<ToolCall> {
        if let Self::ToolCall(tool_call) = self {
            Some(tool_call)
        } else {
            None
    ...
    #[must_use] pub const fn as_tool_response(&self) -> Option<&ToolResponse> {
    ...
    #[must_use] pub fn into_tool_response(self) -> Option<ToolResponse> {
        if let Self::ToolResponse(tool_response) = self {
            Some(tool_response)
        } else {
            None
    ...
    #[must_use] pub const fn as_data(&self) -> Option<&Data> {
    ...
    #[must_use] pub fn into_data(self) -> Option<Data> {
        if let Self::Data(data) = self {
            Some(data)
        } else {
            None
    ...
    #[must_use] pub fn into_a2a_part(self) -> Option<a2a_types::Part> {
        match self {
